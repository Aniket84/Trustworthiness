...
public class CrawlerEditor2 extends Panel {
    ...
    public CrawlerEditor2 () {
        setLayout (new GridBagLayout ());

    	Constrain.add (this, domainLabel = new Label("Truth Finder Web Crawler: "), Constrain.labelLike (0, 0));
